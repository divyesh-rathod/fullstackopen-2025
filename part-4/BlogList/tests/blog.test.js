...
test('when list has 0 blogs, equals the likes of that', () => {
  const result = listHelper.favoriteBlog(listWith0Blog);
...
describe('Auther with max blogs', () => {
  const listWithOneBlog = [
    {
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
  ...
  test('when list has 0 blogs, equals the likes of that', () => {
    const result = listHelper.mostBlogs(listWith0Blog);
    assert.deepStrictEqual(result, null);
  });
...
describe('Auther with max likes', () => {
  const listWithOneBlog = [
    {
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
  ...
  test('when list has 0 blogs, equals the likes of that', () => {
    const result = listHelper.mostLikes(listWith0Blog);
    assert.deepStrictEqual(result, null);
  });
